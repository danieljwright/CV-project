...
![similarity](https://latex.codecogs.com/png.latex?\dpi{110}\color{white}%20\text{similarity}%20=%20\frac{x_1%20\cdot%20x_2}{\max(\|x_1\|_2,%20\epsilon)%20\cdot%20\max(\|x_2\|_2,%20\epsilon)})})
